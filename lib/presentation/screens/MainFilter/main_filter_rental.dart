...
class MainFilterRental extends StatefulWidget {
  final String? type;
  const MainFilterRental({super.key, this.type});

  @override
  State<MainFilterRental> createState() => _MainFilterRentalState();
}

class _MainFilterRentalState extends State<MainFilterRental> {
