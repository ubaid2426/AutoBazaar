...
import 'package:autobazzaar/presentation/screens/Auto_Rental/screens/Location_Time/date_time.dart';
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                buildStepCircle(1, "Delivery", true),
                const Expanded(child: Divider(color: redlight, thickness: 1)),
                buildStepCircle(2, "Return", false),
                const Expanded(child: Divider(color: redlight, thickness: 1)),
          ...
          Row(
            ...
            children: [
              toggleButton("Collect", true),
              const SizedBox(width: 10),
              toggleButton("Self Return", false),
            ],
          ),
