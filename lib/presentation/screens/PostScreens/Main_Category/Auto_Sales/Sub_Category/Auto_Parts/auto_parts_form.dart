...
//   final String title;
//   // final String name;
//   const AutoPartsForm({super.key, required this.title});
...
//                       // Text("Category Type", style: TextStyle(fontWeight: FontWeight.bold)),
//                       // SizedBox(height: 5),
//                       DropDownComponent(
//                         title: "Auto Part Type",
//                         items: autoPartType,
//                         selectedIndex: autoPart,
//                         onChanged: (index) {
//                           setState(() {
//                             autoPart = index;
//                           });
...
//                         titlesub: 'Select Category Sub-Type',
//                       ),
//                       SizedBox(height: 15),
//                       DropDownComponent(
//                         title: "Condition",
