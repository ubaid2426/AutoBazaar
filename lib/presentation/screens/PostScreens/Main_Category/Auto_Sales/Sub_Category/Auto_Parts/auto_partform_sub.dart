...
//   AutoPartsSubform({super.key, required this.autotype, required this.maincategory});
...
//     final fileName = categoryFileMap[widget.maincategory];

//     if (fileName == null) {
//       throw Exception("No matching file for category: ${widget.maincategory}");
//     }
