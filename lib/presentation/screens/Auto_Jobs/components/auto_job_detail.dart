...
import 'package:autobazzaar/presentation/screens/Auto_Jobs/components/horizontal_filterjob.dart';
import 'package:autobazzaar/presentation/screens/detail_screen/detail_screen.dart';
import 'package:flutter/material.dart';

class AutoJobDetail extends StatefulWidget {
  final String title;
  const AutoJobDetail({super.key, required this.title});

  @override
  _AutoJobDetailState createState() => _AutoJobDetailState();
}

class _AutoJobDetailState extends State<AutoJobDetail> {
  bool isGrid = true;
  ...
  Widget _buildGridView(List<Car> premiumCars, List<Car> queuedCars) {
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return GridCard(car, isPremium: isPremium);
      },
    );
  }
      ...
      itemBuilder: (context, index) {
        ...
        final car =
            index < premiumCars.length
                ? premiumCars[index]
                : queuedCars[index - premiumCars.length];
        return ListCard(car, isPremium: isPremium);
      },
    );
  }
}
